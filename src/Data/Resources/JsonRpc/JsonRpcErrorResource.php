...
namespace KLP\KlpMcpServer\Data\Resources\JsonRpc;
...
class JsonRpcErrorResource
{
     ...
     *
     * @param  \KLP\KlpMcpServer\Exceptions\JsonRpcErrorException  $exception  The exception representing the JSON-RPC error.
