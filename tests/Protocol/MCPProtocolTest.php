...
class MCPProtocolTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->mcpProtocol->setProtocolVersion(MCPProtocol::PROTOCOL_SECOND_VERSION);
    }
    ...
    public function test_init_transport_initializes_transport(): void
    {
        ...
        // Mock to simulate TransportFactoryException on get()
        ...
        $mockTransportFactory
            ->expects($this->once())
            ->method('create')
            ->with($this->equalTo(MCPProtocol::PROTOCOL_SECOND_VERSION))
        ...
        $mcpProtocol->setProtocolVersion(MCPProtocol::PROTOCOL_SECOND_VERSION);
    ...
    public function test_connect_starts_transport(): void
    {
        ...
        $this->mcpProtocol->connect(MCPProtocol::PROTOCOL_SECOND_VERSION);
    }
